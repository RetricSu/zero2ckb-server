...
async function use_contract() {
  ...
  const input: Input = {
    previous_output: {
      tx_hash: '0x6aa19cc508a4c3c3ea80c2553ea8d4ba94e1e421e17be89c9925f5dbcf65d1cc',
      index: '0x0'
    },
    since: '0x0'
  };
  ...
  const cell_deps: CellDep[] = [
    ...
    {
      out_point: { // the contract contained carrot code
        tx_hash: '0x9e2619e67244ecb90c9754c022c26537bd4c492f002c220ba910227bf0d17a59',
        index: '0x0'
      },
      dep_type: 'code'
...
async function test_contract() {
  ...
  const input_cells: Cell[] = [{
    ...
    type: {
      args: '0x',
      code_hash: '0x481e019212aabec00cc8f4ff1f05b20f81c1d7a1450a07d88bb7873bb94c72f6',
      hash_type: 'data'
    },
    data: '0x',
    out_point: {
