...
async function deploy(){
    const {length, code} = builder.readContractCodeByFileName('nervos-dao-extended-ownership-script');
    ...
    var raw_tx: RawTransaction = {
        ...
        "inputs": [
            {
                "previous_output": {
                  "tx_hash": "0x8f2a10a44d803308a09839a5d576c335298a03db0db0421ac2394f85d9a98580",
                  "index": "0x0"
                },
                "since": "0x0"
              }
...
async function deploy_as_script(){
    ...
    var raw_tx: RawTransaction = {
        ...
        "inputs": [
          {
            "previous_output": {
              "tx_hash": "0x27d03b81c4a4f664d1543f53b3fdfc8b7b94af58587b9805066191e364882bd3",
              "index": "0x0"
            },
            "since": "0x0"
          }
...
async function deploy_type_id(){
    ...
    var raw_tx: RawTransaction = {
        ...
        "inputs": [
          {
            "previous_output": {
              "tx_hash": "0x769d95f4bd3e7f9e7e866270c1a5a1e3a13dd617d43cfcec30056d99a3b04b3d",
              "index": "0x0"
            },
            "since": "0x0"
          }
...
async function produce_type_id_cell() {
    const type_id_args = builder.generateTypeIDArgs({
        "previous_output": {
          "tx_hash": "0x0dda7f601ea1e89c81e7536f8b4b75bae40872e112eb66699a147a7eec351900",
          "index": "0x0"
        },
        "since": "0x0"
    });
...
async function get_code_hash() {
    const contract = builder.readContractCodeByFileName('nervos-dao-extended-ownership-script');
...
async function use_contract() {
    ...
    inputs: [
      {
        since: "0x0",
        previous_output: {
          tx_hash: "0x9353ba318c466db2139b0cd8813af8cf43f6ea15ae31a2c165486daf00f14c3b",
          index: "0x0",
        },
      },
      {
        since: "0x0",
        previous_output: {
          tx_hash: "0x48b4a5aefaa3e717ddb8fbeb639fd09a2823ae23d8829e0335b79487ae8fe83b",
          index: "0x0",
        },
      }
    ],
   ...
   const tx_hash = '0x683ee8bbe80419f2b1d4dbf3456a0155d60656ba98f1b5ee9182d7bc7487020f';
   const outpoints = raw_tx.inputs.map(input => input.previous_output);
   var input_cells: Cell[] = [];
   try {
        input_cells = await chain.getInputCellsByOutpoints(outpoints);
...
function sign_msg(){
    const msg = '0xabd6f2deb58fb9da65d51fe80e2b6a793f199dad1c57483568e66ec5b384758e';
