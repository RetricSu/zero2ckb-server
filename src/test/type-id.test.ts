...
async function deploy() {
  ...
  const input: Input = {
    previous_output: {
      tx_hash:
        "0x8ed1caf09e6849331d611052f76ba17087f99541ab9fc25ded5a7a4689bfff12",
      index: "0x0",
    },
    since: "0x0",
  };
...
async function use_contract() {
  ...
  const input: Input = {
    previous_output: {
      tx_hash:
        "0x51d36d3b6e57052cfa7626ed5c4e30ebc2c7d001025a8c2f84e4864712f13539",
      index: "0x0",
    },
    since: "0x0",
  };
  ...
  const cell_deps: CellDep[] = [
    ...
    {
      out_point: {
        // the contract contained type_id code
        tx_hash:
          "0xc960f9cdcd44b843f8344cea3b04bcbdbb5e91fd070ccbc3be722eedceac8735",
        index: "0x0",
      },
      dep_type: "code",
    },
  ...
  const tx = await builder.deploy_upgradable_contract(
    code,
    length,
    raw_tx,
    input_cells
...
async function upgrade_contract() {
  ...
  const input: Input = {
    previous_output: {
      tx_hash:
        "0x0374ba76e54f58bcd572ac6b838b76fd729d4282773f02ac031b513ed6232c39",
      index: "0x0",
    },
    since: "0x0",
  };
